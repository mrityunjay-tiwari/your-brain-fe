  ...
  return (
    ...
    >
      <motion.div
        ...
        className="h-auto min-h-[96.4vh] sm:h-auto w-[90%] max-w-[400px] aspect-[9/16] sm:aspect-auto sm:max-w-[1000px] rounded-3xl shadow-2xl border border-neutral-200 overflow-hidden bg-white/70"
      >
