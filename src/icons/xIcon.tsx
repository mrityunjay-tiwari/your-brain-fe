...
export function XIcon(props : shareIconProps) {
    return <svg className={`size-${props.siz} sm:size-${props.siz2} text-gray-800 dark:text-white`} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
